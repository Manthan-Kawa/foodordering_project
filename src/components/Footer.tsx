        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="grid grid-cols-2 gap-8 md:col-span-2 pl-4 md:pl-0">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/reserve" className="text-gray-400 hover:text-white transition-colors">Reserve</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/about" className="text-gray-400 hover:text-white transition-colors">FAQ</Link></li>
          ...
          <div className="grid grid-cols-2 gap-8 md:col-span-2 pl-4 md:pl-0">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/contact" className="text-gray-400 hover:text-white transition-colors">Catering</Link></li>
                <li><Link to="/contact" className="text-gray-400 hover:text-white transition-colors">Private Events</Link></li>
              </ul>
            </div>
          </div>
            ...
            <div className="flex flex-col items-center md:items-start space-y-2.5 md:text-sm">
              {
                [
                  ...
                  { name: "Arya Vora", insta: "https://www.instagram.com/arya_0611/", github: "https://github.com/arya-vora", linkedin: "https://www.linkedin.com/in/arya-vora-7350a7282/"},
                ].map((dev, index) => (
